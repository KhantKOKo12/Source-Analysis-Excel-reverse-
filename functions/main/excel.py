...
class ExcelWorkbook:
    def __init__(self, file_path, table_list_dir):
        ...
        self.sheet_names = []
        self.column_names = []
        self.soft_brown_with_border = None  # Store the named style object
        self.main_cell = None  # Store the named style object
    ...
    def create_named_styles(self):
        ...
        if not hasattr(self, 'soft_brown_with_border') or 'soft_brown_with_border' not in self.workbook.named_styles:
            self.soft_brown_with_border = NamedStyle(name='soft_brown_with_border')
            # Define the soft brown color using hexadecimal color codes
            self.soft_brown_with_border.fill = PatternFill(start_color='D2B48C', end_color='D2B48C', fill_type='solid')
            self.soft_brown_with_border.border = Border(left=Side(border_style='thin', color='000000'),
                                                        right=Side(border_style='thin', color='000000'),
                                                        top=Side(border_style='thin', color='000000'),
                                                        bottom=Side(border_style='thin', color='000000'))
            self.workbook.add_named_style(self.soft_brown_with_border)
        else:
            self.soft_brown_with_border.fill = PatternFill(start_color='D2B48C', end_color='D2B48C', fill_type='solid')
            self.soft_brown_with_border.border = Border(left=Side(border_style='thin', color='000000'),
                                                        right=Side(border_style='thin', color='000000'),
